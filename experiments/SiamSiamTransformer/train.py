...
import json
from models.siamsiam_outer_transformer import SiamSiamTransformer
...
train_path = "siamsiam_trainings"  # path used for training the networks
